...
public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IHttpForwarder forwarder)
    {
        ...
        app.UseEndpoints(endpoints =>
        {
            ...
            {
                var error = await forwarder.SendAsync(httpContext, "http://localhost", httpClient, requestOptions,
                    static (context, proxyRequest) =>
                    {
                        ...
                        proxyRequest.RequestUri = RequestUtilities.MakeDestinationAddress("http://localhost",
                            context.Request.Path, queryContext.QueryString);
    ...
    private class CustomTransformer : HttpTransformer
    {
            ...
            HttpContext httpContext, HttpRequestMessage proxyRequest, string destinationPrefix, CancellationToken cancellationToken)
        {
            ...
            proxyRequest.RequestUri =
                RequestUtilities.MakeDestinationAddress("https://localhost", httpContext.Request.Path, queryContext.QueryString);
